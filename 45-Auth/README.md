...
- send back a token to be stored on the client side
...
What to cover:
- Actually logging in using POST /login
- Have log in persist when we hard reset or change tabs
- JWT
- How to log out (and persist it)
- Creating a user
- Admin? secure tasks? redirecting correctly
