...
Get to know the App
//What does it look like? What is it supposed to do?
//What is the component hierarchy?
//What is state and what does it represent in terms of the App?
//What is our data source?

Planning our implementation
//When some event happens, how does state change?
//Which components change as state changes? How do we pass state down to a child component?

//Deliverables:
- Change the drop down
- Click the button => show the pets 



//When I click the 'Find Pets', based on the drop down, I should see all/some of the pets
//pets: [] represents the pets the user sees
//filters: 'string' represents the drop down
