...
- move the state into the parent component (App)
- move the callbacks to update state (App)
- pass the state down as props (to Header and Counter)
- pass the callbacks as props (to Counter)
- move the actual element and its helper methods to new component
...
X Store
X Create our reducer and
X Create our state that lives inside the store
...
- this.forceUpdate()
- actually reading from the store/state
- More complex state ? 
